...

{
  ...
  m_VBox_wpm.pack_start (*Gtk::manage (new Gtk::Label ("CW Speed [wpm]", 0)), Gtk::PACK_SHRINK);

  m_VBox_txp.set_border_width (10);
  m_VBox_txp.pack_start (m_HScale_txp);
  m_VBox_txp.pack_start (*Gtk::manage (new Gtk::Label ("TX Power [watts]", 0)), Gtk::PACK_SHRINK);
...
void
Scales::on_adjustment_txp_value_changed ()
{
