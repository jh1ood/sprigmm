  ...
  m_Button_Quit("Quit")
{
  ...
  m_ComboBox_Position.signal_changed().connect( sigc::mem_fun(*this, &Scales::on_combo_position) );
  ...
  m_Button_Quit.signal_clicked().connect(sigc::mem_fun(*this, &Scales::on_button_quit));
...
void Scales::on_adjustment1_value_changed()
{
...
void Scales::on_adjustment2_value_changed()
{
